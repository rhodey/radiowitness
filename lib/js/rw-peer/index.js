...
const defaults = {
  ...
  dirAudio: '/archive/pcm16bit8kHz', dirDb: '/archive/db', limit: 0,
  wss: 8081
}
...
switch (cmd0) {
  ...
  case 'create':
    ...
    mkdirp(opts.dirAudio)
      ...
      .then(function () {
        audio = hypercore(opts.dirAudio, opts.dat)
  ...
  case 'mirror':
    ...
    wssMirror.fetchConfig(cmd1).then(function (remote) {
      audio = hypercore(opts.dirAudio, remote.audio, Object.assign(opts.dat, { sparse: true }))
